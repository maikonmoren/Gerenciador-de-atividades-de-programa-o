        ...
        <div id="content">
            <nav class="navbar" style="background-color: yellowgreen">
                <div class="container-fluid">
                    <button type="button" id="sidebarCollapse" class="btn btn-light">
                     ...
                     <h2 class="text-white">Minha salas
                     </h2>
            ...
            <br><br>
             <?php
                        ...
                        $pdo = Connection::getConexao();
                        $sql = 'select t_nome, t_desc , t_att, t_codigo  from tb_turma where t_codigo
                               in(select t_codigo from pe_tu where p_id = '.$_SESSION['p_id'].');';
                        foreach($pdo->query($sql)as $row)
                        {
                            $t_nome=$row['t_nome'];
                            echo '<div class=""><div class="card">';
			    echo '<div class="card-header"><h6 class="card-text">'.$row['t_nome'].'</h6></div>';
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form-signin" method="post" action="../action/turmaAction.php">
                            ...
                            <button class=" btn-lg btn-dark btn-block text-uppercase" type="submit">Criar a sala</button>
    ...
    <div class="modal-content">
      ...
      <form class="form-signin" method="post" action="../action/turmaAction.php">
          ...
          <div class="form-label-group" id="e_senha">
                            ...
                            <input  class="btn btn-lg btn-dark btn-block text-uppercase" value="Entrar na sala" type="submit" >
                            <button type="button"  class="btn-lg btn-block btn-secondary" data-dismiss="modal">Fechar janela</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form-signin" method="post" action="../action/turmaAction.php">
          ...
          <input  class="btn-lg btn-dark btn-block text-uppercase" value="entrar" type="submit">
           <button type="button"  class="btn-lg btn-block btn-secondary" data-dismiss="modal">Fechar janela</button>
      </form>
<div class="modal-footer">
